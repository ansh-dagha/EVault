(function($, window, document, undefined) {
    ...
    Plugin.prototype._create = function() {
            ...
            <ul> \
            <li data-criterion="length" class="invalid">8-20 <strong>characters</strong></li> \
            ...
            <li data-criterion="special" class="invalid"> At least <strong> one special character</strong></li>\
            <li data-criterion="letter" class="invalid">No <strong>spaces</strong></li> \
            </ul> \
            </div>');
        ...
        Plugin.prototype._update_indicator = function(total) {
            ...
            if (total === 0) {
                ...
                meter.addClass('verystrong').html('<p>very strong</p>');
            }
        },
